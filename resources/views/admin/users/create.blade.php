        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">{{trans('admin.addParamedic') }}</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">{{trans('admin.addParamedic') }}</h3>
          </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input name="name" type="text" class="form-control" id="name" placeholder="{{trans('admin.NameParamedicValidation')}}" required>
                  </div>
                  <div class="form-group">
