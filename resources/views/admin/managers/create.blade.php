      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">{{trans('admin.addManager') }}</h3>
          </div>
          <form role="form" action="{{route('managers.store')}}" method="post"
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label>{{trans('admin.NameManager')}}</label>
                    <input name="name" type="text" class="form-control" id="name" placeholder="{{trans('admin.NameManagerValidation')}}" required>
                  </div>
                  <div class="form-group">
